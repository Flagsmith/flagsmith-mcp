...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "env": { "TOKEN_AUTH": "YOUR_VALUE_HERE" },
  };
  const codexConfig = `[mcp_servers.Flagsmith]
url = "${o}/sse"
http_headers = { "token-auth" = "YOUR_TOKEN_AUTH" }`;
...
<head>
    ...
    <title>flagsmith MCP</title>
    <meta name="description" content="Install flagsmith MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="flagsmith - MCP Server">
    <meta property="og:description" content="Install flagsmith MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="flagsmith - MCP Server">
    <meta property="twitter:description" content="Install flagsmith MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">flagsmith</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Flagsmith&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmbGFnc21pdGgiLCJzdGFydCIsIi0tdG9rZW4tYXV0aCIsIiJdfQ==">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Flagsmith&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmbGFnc21pdGgiLCJzdGFydCIsIi0tdG9rZW4tYXV0aCIsIiJdfQ==">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Flagsmith&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmbGFnc21pdGgiLCJzdGFydCIsIi0tdG9rZW4tYXV0aCIsIiJdfQ==">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Flagsmith&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmbGFnc21pdGgiLCJzdGFydCIsIi0tdG9rZW4tYXV0aCIsIiJdfQ==">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add Flagsmith -- npx -y flagsmith start --token-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/Flagsmith/flagsmith-mcp/releases/download/v0.0.2/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add Flagsmith -- npx -y flagsmith start --token-auth </code>
        </div>
      </div>
    </div>
